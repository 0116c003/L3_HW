...
[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://share.streamlit.io/deploy?repository=0116c003/L3_HW&branch=main&mainModule=L3_HW.py)
...
- **學生姓名**：林家葦
- **作業檔名**：`L3_HW.py`
- **Streamlit 一鍵開啟/部署網址**：👉 **[點此直接開啟 Streamlit 網頁](https://share.streamlit.io/deploy?repository=0116c003/L3_HW&branch=main&mainModule=L3_HW.py)**
